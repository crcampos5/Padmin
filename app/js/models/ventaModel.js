function ventaModel($http, $rootScope, CONFIG) {

    var uri = CONFIG.API + 'venta';
    ...
    this.update = function(id, venta, successCallback, errorCallback) {
        var url = uri + "/" + id;
        var data = venta || null;
        var callsuccess = successCallback || null;
        var callerror = errorCallback || null;
    ...
    this.create = function(venta, successCallback, errorCallback) {
        var url = uri;
        var data = venta|| null;
        var callsuccess = successCallback || null;
        var callerror = errorCallback || null;
